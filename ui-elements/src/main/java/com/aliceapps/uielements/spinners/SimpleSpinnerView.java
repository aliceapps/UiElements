...
public class SimpleSpinnerView extends androidx.appcompat.widget.AppCompatSpinner {
     ...
     */
    public SimpleSpinnerView(Context context, AttributeSet attrs) {
     ...
     */
    public SimpleSpinnerView(Context context, int mode) {
     ...
     */
    public SimpleSpinnerView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param mode         Constant describing how the user will select choices from the spinner.
     */
    public SimpleSpinnerView(Context context, AttributeSet attrs, int defStyleAttr, int mode) {
     ...
     * should be inflated.
     * Constructor initializes SimpleSpinnerAdapter
     *
    ...
    public SimpleSpinnerView(Context context, AttributeSet attrs, int defStyleAttr, int mode, Resources.Theme popupTheme) {
        ...
        if (attrs != null) {
            ...
            layoutId = a.getResourceId(R.styleable.SimpleSpinnerView_simple_spinner_item_layout, R.layout.simple_spinner);
            values = a.getTextArray(R.styleable.SimpleSpinnerView_simple_spinner_values);
            a.recycle();
        }

        SimpleSpinnerAdapter adapterEntries = new SimpleSpinnerAdapter(context, entries, values, layoutId);
